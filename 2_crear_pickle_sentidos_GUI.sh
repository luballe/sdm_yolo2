#!/bin/bash
# Usage: 
# ./2_crear_pickle_sentidos_GUI.sh /path/to_files EW,WE,NS,SN
# ./2_crear_pickle_sentidos_GUI.sh /monitoreo/videos_Ago09_Ago13/Ago09/09-08-2021/CL13xKR128/0600-0700/ 128_WE,128_EW,128_ciclo_WE,12_ciclo_EW
pwd_cmd='pwd'
