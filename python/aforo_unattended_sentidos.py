...
if (num_args < 2):
    print("Usage: python2 aforo_unattended.py <path_to_video_file> <path_to_pickle>")
    exit()
...
if os.path.isfile(pickle_file):
    with open(pickle_file) as f:  # Python 3: open(..., 'rb')
...
if not ret_val:
    ...
    with open("Error.txt","a") as f:  # Python 3: open(..., 'rb')
...
for linlin in lineaDeConteo:
    contadores.append(lc.counter(linlin.pt1,linlin.pt2,filename=archsal,linecount=cc,fps=20,sentido=sentidos_arr[cc-1]))
    cc+=1
