...
#8******************************************************************************************************************************OK
def rename_split_results(results_path, Camera_Name, video__Start_Time, YYYYMTDD, initial_time, duration):
    ...
    arg5 : initial_time
        arg Time the video starts (format: HHMM eg 6:00 AM = 600, 4:30 PM = 1630)

    arg5 : duration
        arg Durarion in minutes of the splited videoclips
